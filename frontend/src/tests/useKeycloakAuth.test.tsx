...
describe('useKeycloakAuth', () => {
  ...
  it('login() build a redirect URL and sets window.location.href', async () => {
    ...
    expect(window.location.href).toContain('https://kc.example.com/realms/myrealm/protocol/openid-connect/auth')
    expect(window.location.href).toContain('response_type=code')
    expect(window.location.href).toContain('code_challenge_method=S256')
    expect(window.location.href).toContain('redirect_uri=http%3A%2F%2Flocalhost%3A3000%2Fsso%2Fcallback')
  })
