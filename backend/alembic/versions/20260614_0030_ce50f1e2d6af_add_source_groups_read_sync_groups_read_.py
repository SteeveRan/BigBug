"""add_source_groups_read_sync_groups_read_permissions

Revision ID: ce50f1e2d6af
Revises: d3b03edcb2d5
Create Date: 2026-06-14 00:30:19.775851+00:00
...
revision: str = 'ce50f1e2d6af'
down_revision: Union[str, None] = 'd3b03edcb2d5'
...
# Operator: needs read access to source groups and sync groups
OPERATOR_NEW_PERMISSIONS = [
    "source_groups:read",
    "sync_groups:read",
]

# Viewer: needs read access to source groups and sync groups
