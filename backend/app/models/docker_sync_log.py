...
class DockerSyncLog(Base):
    """Sync run history for Docker image source tag indexing."""

    __tablename__ = "docker_sync_logs"
    ...
    # Relationships
    source = relationship("DockerImageSource", back_populates="sync_logs")
